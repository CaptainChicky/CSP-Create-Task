	...
	function init() {
		...
		function getCursorPosition(canvas, event) {
			...
			document.getElementById("mouseclickcoords").innerHTML =
				"Mouse click coordinates" + "<br />" + "x: " + x + "<br />" + " y: " + y;
		}
		...
		//=============================
		//update: fixed thru a bad hardcoding of coordinates after score detection
		function collect() {
			for (let i = 1; i <= 2; i += 1) {
				if (
					intersects(
		...
		function seteggcoordhtml() {
			document.getElementById("eggcoords").innerHTML =
				"Egg 1 coordinates:" + '<br />' + "(" +
				eggs[0].x +
				", " +
				eggs[0].y +
				")" +
				"<br />" +
				"Egg 2 coordinates:" + '<br />' + "(" +
				eggs[1].x +
				", " +
				eggs[1].y +
				")" +
				"<br />" +
				"Egg 3 coordinates:" + '<br />' + "(" +
				eggs[2].x +
				", " +
				eggs[2].y +
				")";
		...
		function gameend() {
			...
			seteggcoordhtml();
			//todo: display official score at the center of the canvas
		}
